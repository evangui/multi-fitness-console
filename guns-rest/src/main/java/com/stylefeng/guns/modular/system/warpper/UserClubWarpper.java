 ...
 */
public class UserClubWarpper extends BaseControllerWarpper {

    public UserClubWarpper(List<Map<String, Object>> list) {
        super(list);
    }
    ...
    public void warpTheMap(Map<String, Object> map) {
        ...
        map.put("vipId", ConstantFactory.me().getVipIdByClubUserid((Integer) map.get("userId"), (Integer) map.get("clubId")));
