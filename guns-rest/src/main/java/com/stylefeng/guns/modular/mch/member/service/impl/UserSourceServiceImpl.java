...
import com.stylefeng.guns.modular.system.warpper.UserSourceWarpper;
import com.stylefeng.guns.modular.system.dao.UserSourceMapper;
import com.stylefeng.guns.core.util.ToolUtil;
import com.stylefeng.guns.modular.mch.member.service.IUserSourceService;
...
public class UserSourceServiceImpl extends ServiceImpl<UserSourceMapper, UserSource> implements IUserSourceService {
	...
	@Override
	public Page<UserSource> pageList(Page<UserSource> page, Integer clubId, String condition) {
    	
    	Wrapper<UserSource> ew = new EntityWrapper<>();
        ...
        return page.setRecords( (List<UserSource>) new UserSourceWarpper(result).warp());
	}
}
