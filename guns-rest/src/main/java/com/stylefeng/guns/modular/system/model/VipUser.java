...
public class VipUser extends Model<VipUser> {
    ...
    private Integer lastMaintainTime;
    /**
     * 上次签到时间
     */
    ...
    private BigDecimal storedValueCardUsedCounts;
    /**
     * 储值卡总次数
     */
    @TableField("stored_value_card_counts")
    private BigDecimal storedValueCardCounts;
    /**
     * 储值卡数量
     */
    ...
    public Integer getLastMaintainTime() {
        return lastMaintainTime;
    }

    public void setLastMaintainTime(Integer lastMaintainTime) {
    ...
    public BigDecimal getStoredValueCardUsedCounts() {
        return storedValueCardUsedCounts;
    }

    public void setStoredValueCardUsedCounts(BigDecimal storedValueCardUsedCounts) {
        this.storedValueCardUsedCounts = storedValueCardUsedCounts;
    }

    public BigDecimal getStoredValueCardCounts() {
        return storedValueCardCounts;
    }

    public void setStoredValueCardCounts(BigDecimal storedValueCardCounts) {
