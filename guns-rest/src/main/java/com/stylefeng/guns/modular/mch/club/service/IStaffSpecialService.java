...
public interface IStaffSpecialService extends IService<StaffSpecial> {
	...
	Page<StaffSpecial> pageList(Page<StaffSpecial> page, Integer clubId, Integer type, String condition);

	StaffSpecial getByRealname(Integer clubId, String realname, Integer type);
