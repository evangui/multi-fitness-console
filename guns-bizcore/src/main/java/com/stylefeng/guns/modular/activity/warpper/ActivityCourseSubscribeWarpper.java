package com.stylefeng.guns.modular.activity.warpper;
 ...
 */
public class ActivityCourseSubscribeWarpper extends BaseControllerWarpper {

    public ActivityCourseSubscribeWarpper(List<Map<String, Object>> list) {
        super(list);
    }
