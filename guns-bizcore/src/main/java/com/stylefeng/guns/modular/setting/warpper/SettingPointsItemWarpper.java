package com.stylefeng.guns.modular.setting.warpper;
 ...
 */
public class SettingPointsItemWarpper extends BaseControllerWarpper {

    public SettingPointsItemWarpper(List<Map<String, Object>> list) {
        super(list);
    }
