package com.stylefeng.guns.modular.card.warpper;
 ...
 */
public class CardStoredvaluecardRechargeWarpper extends BaseControllerWarpper {

    public CardStoredvaluecardRechargeWarpper(List<Map<String, Object>> list) {
        super(list);
    }
