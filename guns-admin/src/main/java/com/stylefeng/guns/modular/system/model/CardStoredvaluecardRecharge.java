 ...
 * @since 2018-06-22
 */
@TableName("biz_card_storedvaluecard_recharge")
public class CardStoredvaluecardRecharge extends Model<CardStoredvaluecardRecharge> {
    ...
    public String toString() {
        return "CardStoredvaluecardRecharge{" +
        "id=" + id +
        ", clubId=" + clubId +
        ", vipId=" + vipId +
        ", cardId=" + cardId +
