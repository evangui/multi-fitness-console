...
public class SettingSyllabus extends Model<SettingSyllabus> {
    ...
    private Integer subscribeStartTime;
    /**
     * 预约结束时间
     */
    @TableField("subscribe_end_time")
    private Integer subscribeEndTime;
    /**
     * 人数不足自动取消时间
     */
    ...
    private Integer selfCancelTime;
    /**
     * 团操课查看开始时间戳
     */
    ...
    public Integer getSubscribeStartTime() {
        return subscribeStartTime;
    }

    public void setSubscribeStartTime(Integer subscribeStartTime) {
        this.subscribeStartTime = subscribeStartTime;
    }

    public Integer getSubscribeEndTime() {
        return subscribeEndTime;
    }

    public void setSubscribeEndTime(Integer subscribeEndTime) {
    ...
    public Integer getSelfCancelTime() {
        return selfCancelTime;
    }

    public void setSelfCancelTime(Integer selfCancelTime) {
