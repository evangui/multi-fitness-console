...
public class SettingCard extends Model<SettingCard> {
    ...
    private Integer cardStartUseTimeSwitch;
    /**
     * 是否开启会员录入密码
     */
    @TableField("vip_passwd_switch")
    private Integer vipPasswdSwitch;
    ...
    public Integer getCardStartUseTimeSwitch() {
        return cardStartUseTimeSwitch;
    }

    public void setCardStartUseTimeSwitch(Integer integer) {
        this.cardStartUseTimeSwitch = integer;
    }

    public Integer getVipPasswdSwitch() {
        return vipPasswdSwitch;
    }

    public void setVipPasswdSwitch(Integer vipPasswdSwitch) {
        this.vipPasswdSwitch = vipPasswdSwitch;
    }
