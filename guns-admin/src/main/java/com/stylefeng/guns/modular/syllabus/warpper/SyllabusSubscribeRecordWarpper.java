package com.stylefeng.guns.modular.syllabus.warpper;
 ...
 */
public class SyllabusSubscribeRecordWarpper extends BaseControllerWarpper {

    public SyllabusSubscribeRecordWarpper(List<Map<String, Object>> list) {
        super(list);
    }
