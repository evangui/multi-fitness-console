...
import com.stylefeng.guns.modular.club.warpper.ClubWarpper;
...
public class ClubServiceImpl extends ServiceImpl<ClubMapper, Club> implements IClubService {
	...
	@Override
	public Page<Club> pageList(Page<Club> page, String condition) {
		Wrapper<Club> ew = new EntityWrapper<>();
    	if (ToolUtil.isNotEmpty(condition)) {
    		ew = ew.like("name", condition).or().like("remark_by", condition);
    	}
