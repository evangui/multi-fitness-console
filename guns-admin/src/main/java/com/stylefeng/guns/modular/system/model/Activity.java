...
public class Activity extends Model<Activity> {
    ...
    private Integer enrollStartTime;
    /**
     * 报名结束时间
     */
    ...
    public Integer getEnrollStartTime() {
        return enrollStartTime;
    }

    public void setEnrollStartTime(Integer enrollStartTime) {
        this.enrollStartTime = enrollStartTime;
    }

    public Integer getEnrollEndTime() {
        return enrollEndTime;
    }

    public void setEnrollEndTime(Integer enrollEndTime) {
